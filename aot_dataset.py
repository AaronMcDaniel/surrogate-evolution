    ...
    def __init__(self, mode, string=None, bad_data=None, cache_thresh=1, max_size=None, seed=None):
        ...
        if bad_data == None:
            if string == None:
                ...
                if mode == 'train':
                    # self.pickle_path = '/home/hice1/tthakur9/scratch/surrogate-evolution/aot_data/train/Labels/part1_STRING_TENSORV2_SHRUNKEN_labels.pkl'
                    self.pickle_path = '/storage/ice-shared/vip-vvk/data/AOT/aot_data/train/Labels/part1_STRING_TENSORV2_SHRUNKEN_labels.pkl'
                    # self.image_folder = '/home/hice1/tthakur9/scratch/surrogate-evolution/aot_data/train'
                    self.image_folder = '/storage/ice-shared/vip-vvk/data/AOT/aot_data/train'
                elif mode == 'val':
                    # self.pickle_path = '/home/hice1/tthakur9/scratch/surrogate-evolution/aot_data/val/Labels/part2_STRING_TENSORV2_SHRUNKEN_labels.pkl'
                    self.pickle_path = '/storage/ice-shared/vip-vvk/data/AOT/aot_data/val/Labels/part2_STRING_TENSORV2_SHRUNKEN_labels.pkl'
                    # self.image_folder = '/home/hice1/tthakur9/scratch/surrogate-evolution/aot_data/val'
