...
#SBATCH --output=dmytro_repo/logs/dmytro_model_training_hrnet48.%A.%a.out
#SBATCH --error=dmytro_repo/logs/dmytro_model_training_hrnet48.%A.%a.err
#SBATCH --time=20-00:00
#SBATCH --mem=32G
#SBATCH -c 8
#SBATCH -G 1
#SBATCH -x ice109,ice111,ice161,ice113,ice116,ice114,ice170,ice149,ice158,ice177,ice178,ice120
#SBATCH -C "NVIDIAA100-SXM4-80GB"
