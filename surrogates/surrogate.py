...
def main():
    surrogate = Surrogate('conf.toml', '/storage/ice-shared/vip-vvk/data/AOT/surrogate_dataset')
    cls_train_df = pd.read_pickle('/storage/ice-shared/vip-vvk/data/AOT/surrogate_dataset/surr_v2_cls_train.pkl')
    cls_val_df = pd.read_pickle('/storage/ice-shared/vip-vvk/data/AOT/surrogate_dataset/surr_v2_cls_val.pkl')
    reg_train_df = pd.read_pickle('/storage/ice-shared/vip-vvk/data/AOT/surrogate_dataset/surr_v2_reg_train.pkl')
    reg_val_df = pd.read_pickle('/storage/ice-shared/vip-vvk/data/AOT/surrogate_dataset/surr_v2_reg_val.pkl')
