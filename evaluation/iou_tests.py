...
ciou_custom = u.iou_matrix(pred_boxes, true_boxes, "ciou")
...
print(f"ciou with custom func: {ciou_custom}")

print("ciou edge tests:")

def print_result(description, pred_boxes, true_boxes):
        print(f"{description}")
        ciou_scores = u.ciou(pred_boxes, true_boxes)
        print(f"Pred Boxes: {pred_boxes}")
        print(f"True Boxes: {true_boxes}")
        print(f"CIoU scores:\n{ciou_scores}\n")

pred_boxes1 = torch.tensor([[0.5, 0.5, 0.2, 0.2]])
true_boxes1 = torch.tensor([[0.5, 0.5, 0.2, 0.2]])
print_result("perfect overlap", pred_boxes1, true_boxes1)

pred_boxes2 = torch.tensor([[0.1, 0.1, 0.2, 0.2]])
true_boxes2 = torch.tensor([[0.9, 0.9, 0.2, 0.2]])
print_result("non-overlapping", pred_boxes2, true_boxes2)

pred_boxes3 = torch.tensor([[0.5, 0.5, 0.8, 0.8]])
true_boxes3 = torch.tensor([[0.5, 0.5, 0.2, 0.2]])
print_result("one box inside another", pred_boxes3, true_boxes3)

pred_boxes4 = torch.tensor([[0.1, 0.1, 0.2, 0.2]])
true_boxes4 = torch.tensor([[0.3, 0.1, 0.2, 0.2]])
print_result("touching edges", pred_boxes4, true_boxes4)

pred_boxes5 = torch.tensor([[0.5, 0.5, 0.0, 0.2], [0.5, 0.5, 0.2, 0.0]])
true_boxes5 = torch.tensor([[0.5, 0.5, 0.2, 0.2], [0.5, 0.5, 0.2, 0.2]])
print_result("zero area", pred_boxes5, true_boxes5)

pred_boxes6 = torch.tensor([[0.5, 0.5, 0.4, 0.2]])
true_boxes6 = torch.tensor([[0.5, 0.5, 0.2, 0.4]])
print_result("different aspect ratios", pred_boxes6, true_boxes6)
