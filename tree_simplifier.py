...
def simplify_individual(individual):
    ...
    try:
        ...
        simplified_individual = CustomPrimitiveTree.from_string(simplified_string)
        ...
        # If conversion fails, return the original individual
        print(f"Warning: Failed to create simplified individual: {e}")
        return individual
