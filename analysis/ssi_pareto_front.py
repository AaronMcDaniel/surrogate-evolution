...
if __name__ == "__main__":
    ...
    dataframes = [
        {'df': df_ssi_1, 'name': 'SSI 1', 'colors': ['xkcd:cerulean', 'xkcd:azure', 'xkcd:slate grey', 'xkcd:sky blue'], 'marker': 'o'}, 
        {'df': df_ssi_2, 'name': 'SSI 2', 'colors': ['xkcd:lime green', 'xkcd:forest green', 'xkcd:grey', 'xkcd:slate'], 'marker': 's'}
    ]
    ...
    for dataframe in dataframes:
        ...
        gens_superset.update(list(df['gen']))
