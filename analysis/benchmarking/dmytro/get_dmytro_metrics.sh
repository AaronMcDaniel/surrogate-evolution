...
python -m analysis.benchmarking.dmytro.dmytro_eval_script -g dmytro_metrics/epochs/$((SLURM_ARRAY_TASK_ID)) -o /gv1/projects/GRIP_Precog_Opt/unseeded_baseline_evolution --job_id $((SLURM_ARRAY_TASK_ID))
